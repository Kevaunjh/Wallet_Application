...
const RecentTransactions = () => {
  ...
  return (
    <div className="bg-[#88ca92] min-h-screen flex flex-col items-center 2xl:p-2 overflow-hidden relative"> {/* Prevent main container from scrolling */}
      ...
      <div className="bg-white fixed top-0 left-0 right-0 z-20 p-8 shadow-md flex justify-between items-center">
        <Link
          to="/Main"
          className="text-lg rounded-full p-2 bg-[#467a4d] text-white"
        >
          &larr; Back
        </Link>
        <h1 className="text-4xl font-bold text-[#467a4d] text-center w-full">
          Transaction History
        </h1>
      ...
      <div className="overflow-y-auto h-[calc(100vh-120px)] mt-32 w-full px-8"> {/* Adjust height and add top margin */}
