...
function Pinlock() {
  ...
  return (
    <div className="Pinlock bg-[#88ca92] h-screen flex flex-col justify-center items-center xl:p-8">
      {/* Container for Title, Back Button, Form, and Proceed Button */}
      <div className="bg-white p-8 xl:p-16 xl:rounded-3xl shadow-2xl flex flex-col items-center w-screen xl:max-w-3xl mx-auto min-h-screen  xl:h-auto xl:border-2 xl:border-black">
        {/* Back Button */}
